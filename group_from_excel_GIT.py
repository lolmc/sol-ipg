...
cwd
# Change directory
os.chdir("path/to/excel_file")
# List all files and directories in current directory
os.listdir('.')
# Assign spreadsheet filename to `file`
file = 'Report_IPAM_-_All_Subnets.xlsx'

# Create the xml file fields
...
f = open('exported_subnets.xml', 'w')
f.write(ipgheader)
with open('exported_subnets.xml') as f:
    for line in f:
        print(line, end='')
